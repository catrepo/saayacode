...
public void alumno(SelectEvent evt){
 ...
 tab_alumno.getColumna("ide_yaldap").setOrden(1);
 tab_alumno.getColumna("nombre_yaldap").setOrden(2);
 tab_alumno.getColumna("apellido_yaldap").setOrden(3);
 tab_alumno.getColumna("ide_ystdoi").setOrden(4);
 tab_alumno.getColumna("doc_identidad_yaldap").setOrden(5);
 tab_alumno.getColumna("ide_ysttis").setOrden(6);
 tab_alumno.getColumna("edad_yaldap").setOrden(7);
 tab_alumno.getColumna("ide_ystgen").setOrden(8);
 tab_alumno.getColumna("fecha_nac_yaldap").setOrden(9);
 tab_alumno.getColumna("ide_ystdip").setOrden(10);
 tab_alumno.getColumna("fotografia_yaldap").setOrden(11);
 tab_alumno.getColumna("firma_yaldap").setOrden(12);
 tab_alumno.getColumna("activo_yaldap").setOrden(13);
...
tab_alumno_telefono.setId("tab_alumno_telefono");
  ...
  int_opcion=6;   
   tab_archivo_alumno.setId("tab_archivo_alumno");
    ...
    tab_archivo_alumno.setCondicion("ide_yaldap="+aut_alumno.getValor());
     ...
     tab_archivo_alumno.getColumna("activo_yaldfe").setOrden(5);
 ...
 tab_dato_academico.getColumna("ide_ide_ystins").setOrden(6);
...
public void dibujarTablaDatosMedicos(){
 ...
 tab_dato_medico.getColumna("yav_ide_yalenf").setCombo(ser_alumno.getEnfermedad());
 tab_dato_medico.getColumna("yav_ide_yalenf").setNombreVisual("TIPO ENFERMEDAD CRONICA");
 tab_dato_medico.getColumna("yav_ide_yalenf").setOrden(12);
 ...
 tab_dato_medico.getColumna("tratemiento_yaldam").setOrden(4);
...
public void dibujarTablaAficiones(){
 ...
 tab_aficiones.getColumna("ide_yaltia").setOrden(3);
 ...
 tab_aficiones.getColumna("activo_yalafi").setOrden(4);
