...
tab_alumno_telefono.setId("tab_alumno_telefono");
 ...
 tab_dato_academico.getColumna("ide_ystins").setNombreVisual("INSTITUCION");
...
public void dibujarTablaDatosMedicos(){
 ...
 //tab_dato_medico.getColumna("ide_yaldam").setNombreVisual("CODIGO");
 //tab_dato_medico.getColumna("descripcion_yalemf").setNombreVisual("DESCRIPCION ENFERMEDAD");
 //tab_dato_medico.getColumna("tipo_yalemf").setNombreVisual("TIPO ENFERMEDAD");
 //tab_dato_medico.getColumna("ide_yaltit").setNombreVisual("CODIGO TRATAMIENTO");
 //tab_dato_medico.getColumna("descripcion_yaltit").setNombreVisual("DESCRIPCION TIPO TRATAMIENTO");
